...
from .models import (Content, ModelConfig, Source, Topic, TopicPrediction,
                     TrainingExample)
...
class ModelConfigAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            ...
            {
                "fields": ("parameters",),
                "description": "Parameters should include: model_type (small/medium/large), num_epochs, num_iterations, batch_size",  # noqa: E501
            },
        ),
    )
